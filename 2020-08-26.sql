...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HR"."SEQ_BOARD"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 121 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_BOARD4_CMT
--------------------------------------------------------

   CREATE SEQUENCE  "HR"."SEQ_BOARD4_CMT"  MINVALUE 0 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 16 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_USER
--------------------------------------------------------

   CREATE SEQUENCE  "HR"."SEQ_USER"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 30 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_USERLOGINHISTORY
--------------------------------------------------------

   CREATE SEQUENCE  "HR"."SEQ_USERLOGINHISTORY"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 64 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (53,'출첵','ㅋ',5,18,to_date('20/08/21','RR/MM/DD'),to_date('20/08/21','RR/MM/DD'));
...
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (83,'너무 쉽다','1등 하는 게 밥먹는거보다 쉽다',23,29,to_date('20/08/25','RR/MM/DD'),to_date('20/08/25','RR/MM/DD'));
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (57,'🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾','🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾🐾',8,23,to_date('20/08/21','RR/MM/DD'),to_date('20/08/21','RR/MM/DD'));
...
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (21,'😏😏','22',0,13,to_date('20/08/20','RR/MM/DD'),to_date('20/08/21','RR/MM/DD'));
...
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (59,'저도 배우고 싶어요.....','꼰대가 될 수 있는 방법을......✌',10,25,to_date('20/08/21','RR/MM/DD'),to_date('20/08/21','RR/MM/DD'));
...
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (28,'수기야22','합격수기 쓰자',2,18,to_date('20/08/20','RR/MM/DD'),to_date('20/08/21','RR/MM/DD'));
...
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (101,'내일 점심은 1짜장','와 신난다 ㅎㅎ',12,18,to_date('20/08/26','RR/MM/DD'),to_date('20/08/26','RR/MM/DD'));
...
Insert into HR.T_BOARD4_CMT (I_CMT,I_USER,I_BOARD,CMT,R_DT,M_DT) values (12,12,101,'hansote',to_date('20/08/26','RR/MM/DD'),to_date('20/08/26','RR/MM/DD'));
