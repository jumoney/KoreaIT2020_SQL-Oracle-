...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HR"."SEQ_BOARD"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 101 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HR"."SEQ_USERLOGINHISTORY"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 31 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (48,'어이 심영이','공산당 할꺼야 안할꺼야?!',1,20,to_date('20/08/21','RR/MM/DD'),to_date('20/08/21','RR/MM/DD'));
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (50,'안하겠소!','닷시는 안하겠소!',3,21,to_date('20/08/21','RR/MM/DD'),to_date('20/08/21','RR/MM/DD'));
...
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (83,'너무 쉽다','1등 하는 게 밥먹는거보다 쉽다',1,29,to_date('20/08/25','RR/MM/DD'),to_date('20/08/25','RR/MM/DD'));
...
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (61,'누가 ip소리를 내었어?','관심법이느니라',16,22,to_date('20/08/24','RR/MM/DD'),to_date('20/08/24','RR/MM/DD'));
...
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (51,'☆폭발★','퍼엉 으아하하~~~',35,12,to_date('20/08/21','RR/MM/DD'),to_date('20/08/21','RR/MM/DD'));
...
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (81,'sooooooooo','ki',7,13,to_date('20/08/25','RR/MM/DD'),to_date('20/08/25','RR/MM/DD'));
Insert into HR.T_BOARD4 (I_BOARD,TITLE,CTNT,HITS,I_USER,R_DT,M_DT) values (82,'👀','👁‍🗨👁‍🗨',12,18,to_date('20/08/25','RR/MM/DD'),to_date('20/08/25','RR/MM/DD'));
